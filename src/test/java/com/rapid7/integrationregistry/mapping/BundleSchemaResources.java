 ...
 *
 * <p>Owns the single {@link ObjectMapper} reused across schema and fixture parsing, the
 * schema/fixture classpath roots, and the JSON-Pointer extraction used by enum-vs-schema sync
 * checks.
 */
