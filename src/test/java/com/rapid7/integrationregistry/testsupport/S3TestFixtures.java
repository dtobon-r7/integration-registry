...
/**
 * Shared helpers for tests that stub the AWS SDK v2 {@code S3Client.getObject(...)} call with
...
public final class S3TestFixtures {
  ...
  /**
   * Wrap a byte array as the {@link ResponseBytes} value the AWS SDK v2 {@code
   * ResponseTransformer.toBytes()} would produce on a successful {@code GetObject}. The {@link
   * GetObjectResponse} envelope is empty.
   */
