...
final class LayerDependencyRules {
  ...
  static final ArchRule controllerLayer_shouldNotDependOnInternalLayers =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..coordinator..", "..adapter..", "..aggregator..", "..mapping..");
  ...
  static final ArchRule aggregatorLayer_shouldOnlyDependOnAdapterAndMapping =
      noClasses()
          .that()
          .resideInAPackage("..aggregator..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..controller..", "..service..", "..coordinator..");
  ...
  static final ArchRule mappingCoreLayer_shouldNotDependOnFrameworks =
      noClasses()
          ...
          .and()
          .resideOutsideOfPackages("..mapping.loader..", "..mapping.exception..")
          .should()
          .dependOnClassesThat()
  ...
  static final ArchRule adapterExceptions_shouldExtendAdapterExceptionParent =
      classes()
          .that()
          .resideInAPackage("..adapter.exception..")
          .and()
          .areNotInterfaces()
          .and(DescribedPredicate.not(JavaClass.Predicates.type(AdapterException.class)))
          .should()
          .beAssignableTo(AdapterException.class)
          .because(
              "ADR-001: every concrete class in adapter.exception must extend "
