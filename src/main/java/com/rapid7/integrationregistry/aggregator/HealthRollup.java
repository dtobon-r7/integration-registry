...
/**
 * Worst-state-wins reduction over the RFC-001 status precedence: {@code error > missing_data >
 * warning > disabled > healthy}.
 *
 * <p>Call sites that need to reduce a stream of statuses can use {@code
 * stream.reduce(HealthRollup::worstOf)} directly.
 */
