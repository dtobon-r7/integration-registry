 ...
 * layer.
 *
 * <p>Each record maps directly to a response body or embedded object in RFC-001 §Read API
 * Contract:
 *
 * <ul>
 *   <li>{@link com.rapid7.integrationregistry.aggregator.projection.VendorServiceCard} — one row
 *       in {@code GET /vendor-services}
 ...
 *   <li>{@link com.rapid7.integrationregistry.aggregator.projection.IntegrationDetail} — per-instance
 *       row nested inside {@code DataSourceDetail}
 *   <li>{@link com.rapid7.integrationregistry.aggregator.projection.IntegrationTypeCount} — per-type
 *       breakdown nested in {@code VendorServiceCard} and {@code VendorServiceDetail}
 * </ul>
 *
