...
/**
 * Map-backed implementation of {@link VendorMappingSnapshot}. Constructed by {@link BundleParser}
 * from a parsed and schema-validated bundle; immutable for the lifetime of the object.
 *
 * <p>Package-private — only {@code BundleParser} and tests within this package construct instances.
 * Callers outside this package depend on the {@link VendorMappingSnapshot} interface.
 */
final class MapBackedVendorMappingSnapshot implements VendorMappingSnapshot {
  ...
  /**
   * Package-private factory exposed to {@link BundleParser} (for index construction) and to tests
   * in this package — keeps {@code TripletKey} fully encapsulated as an implementation detail.
   */
