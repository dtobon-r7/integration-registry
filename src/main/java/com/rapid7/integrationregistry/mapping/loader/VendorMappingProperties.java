...
public record VendorMappingProperties(
    ...
    /**
     * {@code vMAJOR.MINOR.PATCH} — matches the bundle artifact-version naming
     * convention. Rejecting anything else at boot prevents path-traversal
     * residue ({@code ..}) or whitespace from sneaking into the cache filename
     * or the S3 key.
     */
